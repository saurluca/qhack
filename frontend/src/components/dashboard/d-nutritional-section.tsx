...
const DNutritionalSection: React.FC<DNutritionalSectionProps> = ({
  ...
  const nutritionStats = Object.entries(nutritionData.weeklyAverage).map(
    ([nutrient, value]) => {
  ...
  return (
    <div className="space-y-6">
      <DStatsSummaryCard title="Nutritional Balance" stats={nutritionStats} />
