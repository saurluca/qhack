        ...
        <div className="flex items-center mb-3">
          ...
          <div className="flex-1">
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="font-medium">€{budgetData.currentSpent}</span>
            </div>
            ...
            <div className="flex justify-between text-sm mt-1">
              <span className="font-medium text-green-600">
                €{budgetData.monthlyBudget - budgetData.currentSpent} remaining
              </span>
                  ...
                  <div className="ml-3 w-16 text-xs">
                    {category.amount > category.previousMonth ? (
                      <span className="text-red-500">
                        ↑ +€
                        {(category.amount - category.previousMonth).toFixed(0)}
                      </span>
                    ) : (
                      <span className="text-green-500">
                        ↓ -€
                        {(category.previousMonth - category.amount).toFixed(0)}
                      </span>
                    )}
                  </div>
                </div>
