...
const Dashboard: React.FC = () => {
  const [mainTab, setMainTab] = useState<
    "sustainability" | "nutritional" | "smart-shopping"
  >("nutritional");
  const [nutritionView, setNutritionView] = useState<"weekly" | "monthly">(
    "weekly",
  );
  const [carbonView, setCarbonView] = useState<"overview" | "details">(
    "overview",
  );
  const [shoppingView, setShoppingView] = useState<
    "spending" | "savings" | "recommendations"
  >("spending");
          ...
          <div className="space-y-6">
            ...
            {nutritionView === "weekly" ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                {Object.entries(mockNutritionData.weeklyAverage).map(
                  ([nutrient, value]) => {
                    const recommended =
                      mockNutritionData.recommended[
                        nutrient as keyof typeof mockNutritionData.recommended
                      ];
                      ...
                      >
                        ...
                        {(percentage < 80 || percentage > 120) && (
                          <div className="mt-2 text-xs text-gray-600 bg-gray-50 p-1 rounded">
                            ...
                            {percentage < 80
                              ? `Increase ${nutrient} intake by adding more ${
                                  nutrient === "protein"
                              ...
                              : `Reduce ${nutrient} consumption by limiting ${
                                  nutrient === "protein"
                                    ? "processed meats"
                                    : nutrient === "carbs"
                                      ? "refined sugars"
            ...
            <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  >
                    <div className="flex justify-between">
                      <div>
                        ...
                        <span
                          className={`inline-block px-2 py-0.5 text-xs rounded-full mt-1 ${recipe.type === "vegetarian" ? "bg-green-100 text-green-800" : "bg-orange-100 text-orange-800"}`}
                        >
                          {recipe.type}
                        </span>
                      </div>
              ...
              <div className="mt-4 flex">
                <button className="flex-1 mr-2 bg-yellow-100 text-yellow-700 py-2 rounded-md text-xs font-medium hover:bg-yellow-200 transition flex items-center justify-center">
                  <svg
                ...
                <button className="flex-1 bg-green-100 text-green-700 py-2 rounded-md text-xs font-medium hover:bg-green-200 transition flex items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 mr-1"
                    viewBox="0 0 20 20"
              ...
              <div className="bg-white p-4 rounded-lg shadow">
                ...
                <div className="flex items-end space-x-2">
                  <span className="text-3xl font-bold">
                    {mockCarbonData.weeklyTotal}
                  </span>
                  <span className="text-gray-500 text-sm mb-1">kg CO₂</span>
                </div>
                <div className="mt-2">
                  <div className="text-sm text-gray-600">
                    Daily Average: {mockCarbonData.weeklyAverage} kg CO₂
                  </div>
                  <div className="text-sm mt-1">
                    {mockCarbonData.weeklyAverage >
                    mockCarbonData.sustainableTarget ? (
                ...
                <div className="mt-4 h-3 w-full bg-gray-200 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min((mockCarbonData.weeklyAverage / mockCarbonData.sustainableTarget) * 100, 150)}%`,
                    }}
                  ></div>
                </div>
                  ...
                  {mockCarbonData.topContributors.map((item, index) => (
                    <div key={index} className="flex items-center">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500">
                          {(
                            (item.impact / mockCarbonData.weeklyTotal) *
                            100
                          ).toFixed(0)}
                          % of total
                        </div>
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <div className="flex items-center mb-3">
                    <div className="w-16 h-16 rounded-full bg-pink-100 text-pink-600 flex items-center justify-center text-xl font-bold mr-4">
                      {Math.round(
                        (mockBudgetData.currentSpent /
                          mockBudgetData.monthlyBudget) *
                          100,
                      )}
                      %
                    </div>
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    ...
                    <div className="space-y-3">
                      {mockBudgetData.categoryBreakdown.map(
                        (category, index) => (
                          <div key={index}>
                            <div className="flex justify-between text-sm mb-1">
                ...
                <div className="text-center mb-6">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-pink-100 text-pink-600 mb-2">
                    <span className="text-2xl font-bold">
                      €{mockBudgetData.savingsThisMonth}
                    </span>
                  </div>
                  <h3 className="text-lg font-semibold">
